...
export const CRIME_DT_TABLE_NAME = "crime_rewards"
export const TRAINING_DT_TABLE_NAME = "training_rewards"
export const JOB_DT_TABLE_NAME = "job_rewards"

/** @type {Map<string, string>} */
export const jsNameToTableName = new Map();
jsNameToTableName.set("Crime", CRIME_DT_TABLE_NAME);
